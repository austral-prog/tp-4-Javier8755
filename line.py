def line():
    coeficienteA = input("Ingrese el coeficiente A:")
    coeficienteB = input("Ingrese el coeficiente B:")
    coeficienteX1 = input("Ingrese el coeficiente X1:") 
    coeficienteX2 = input("Ingrese el coeficiente X2:")
